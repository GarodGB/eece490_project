...
git add docs/PROJECT_EXPLANATION.md PROJECT_GUIDE.md docs/ML_MODELS.md diagrams/
...
git add .gitignore
git add scripts/git_project_commit.sh scripts/git_commit_plan.pipe docs/GIT_COMMIT_PLAN.md
...
git add README.md docs/GIT_COMMIT_PLAN.md docs/README.md docs/*.md Data/README.md PROJECT_GUIDE.md
